...
`timescale 1 ps / 1 ps
module hello_mm_interconnect_0 (
	...
	wire  [16:0] nios2_qsys_data_master_translator_avalon_universal_master_0_address;              // nios2_qsys_data_master_translator:uav_address -> nios2_qsys_data_master_agent:av_address
	...
	wire  [16:0] nios2_qsys_instruction_master_translator_avalon_universal_master_0_address;       // nios2_qsys_instruction_master_translator:uav_address -> nios2_qsys_instruction_master_agent:av_address
	...
	wire  [92:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire  [16:0] nios2_qsys_jtag_debug_module_agent_m0_address;                                    // nios2_qsys_jtag_debug_module_agent:m0_address -> nios2_qsys_jtag_debug_module_translator:uav_address
	...
	wire  [93:0] nios2_qsys_jtag_debug_module_agent_rf_source_data;                                // nios2_qsys_jtag_debug_module_agent:rf_source_data -> nios2_qsys_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [93:0] nios2_qsys_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_qsys_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_qsys_jtag_debug_module_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> nios2_qsys_jtag_debug_module_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                            // nios2_qsys_jtag_debug_module_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> nios2_qsys_jtag_debug_module_agent:cp_channel
	...
	wire  [16:0] onchip_rom_s1_agent_m0_address;                                                   // onchip_rom_s1_agent:m0_address -> onchip_rom_s1_translator:uav_address
	...
	wire  [93:0] onchip_rom_s1_agent_rf_source_data;                                               // onchip_rom_s1_agent:rf_source_data -> onchip_rom_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] onchip_rom_s1_agent_rsp_fifo_out_data;                                            // onchip_rom_s1_agent_rsp_fifo:out_data -> onchip_rom_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_003_src_data;                                                             // cmd_mux_003:src_data -> onchip_rom_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                            // onchip_rom_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> onchip_rom_s1_agent:cp_channel
	...
	wire  [93:0] onchip_ram_s1_agent_rf_source_data;                                               // onchip_ram_s1_agent:rf_source_data -> onchip_ram_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] onchip_ram_s1_agent_rsp_fifo_out_data;                                            // onchip_ram_s1_agent_rsp_fifo:out_data -> onchip_ram_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> onchip_ram_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                            // onchip_ram_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> onchip_ram_s1_agent:cp_channel
	...
	wire  [92:0] nios2_qsys_data_master_agent_cp_data;                                             // nios2_qsys_data_master_agent:cp_data -> router:sink_data
	...
	wire  [92:0] nios2_qsys_instruction_master_agent_cp_data;                                      // nios2_qsys_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [92:0] sysid_qsys_control_slave_agent_rp_data;                                           // sysid_qsys_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [92:0] nios2_qsys_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	wire  [92:0] onchip_rom_s1_agent_rp_data;                                                      // onchip_rom_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [92:0] onchip_ram_s1_agent_rp_data;                                                      // onchip_ram_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] router_src_data;                                                                  // router:src_data -> nios2_qsys_data_master_limiter:cmd_sink_data
	...
	wire  [92:0] nios2_qsys_data_master_limiter_cmd_src_data;                                      // nios2_qsys_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [92:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> nios2_qsys_data_master_limiter:rsp_sink_data
	...
	wire  [92:0] nios2_qsys_data_master_limiter_rsp_src_data;                                      // nios2_qsys_data_master_limiter:rsp_src_data -> nios2_qsys_data_master_agent:rp_data
	...
	wire  [92:0] router_001_src_data;                                                              // router_001:src_data -> nios2_qsys_instruction_master_limiter:cmd_sink_data
	...
	wire  [92:0] nios2_qsys_instruction_master_limiter_cmd_src_data;                               // nios2_qsys_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [92:0] rsp_mux_001_src_data;                                                             // rsp_mux_001:src_data -> nios2_qsys_instruction_master_limiter:rsp_sink_data
	...
	wire  [92:0] nios2_qsys_instruction_master_limiter_rsp_src_data;                               // nios2_qsys_instruction_master_limiter:rsp_src_data -> nios2_qsys_instruction_master_agent:rp_data
	...
	wire  [92:0] cmd_demux_001_src2_data;                                                          // cmd_demux_001:src2_data -> cmd_mux_004:sink1_data
	...
	wire  [92:0] rsp_demux_004_src1_data;                                                          // rsp_demux_004:src1_data -> rsp_mux_001:sink2_data
	...
	hello_mm_interconnect_0_router router (
	...
	hello_mm_interconnect_0_router_001 router_001 (
	...
	hello_mm_interconnect_0_router_002 router_002 (
	...
	hello_mm_interconnect_0_router_002 router_003 (
	...
	hello_mm_interconnect_0_router_004 router_004 (
	...
	hello_mm_interconnect_0_router_004 router_005 (
	...
	hello_mm_interconnect_0_router_004 router_006 (
	...
	hello_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                          //        clk.clk
		.reset              (nios2_qsys_reset_n_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	hello_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                                 //        clk.clk
		.reset              (nios2_qsys_reset_n_reset_bridge_in_reset_reset),              //  clk_reset.reset
	...
	hello_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	hello_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
