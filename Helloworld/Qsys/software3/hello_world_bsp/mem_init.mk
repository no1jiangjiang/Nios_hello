...
# Memory: onchip_rom
MEM_1 := hello_onchip_rom
$(MEM_1)_NAME := onchip_rom
...
$(MEM_1)_START := 0x00014000
$(MEM_1)_END := 0x000167ff
$(MEM_1)_SPAN := 0x00002800
$(MEM_1)_HIERARCHICAL_PATH := onchip_rom
$(MEM_1)_WIDTH := 32
...
.PHONY: onchip_rom
onchip_rom: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
