...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../hello.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x19000
SOPC_SYSID_FLAG += --sidp=0x19000
ELF_PATCH_FLAG  += --sidp 0x19000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1691052364
SOPC_SYSID_FLAG += --timestamp=1691052364
ELF_PATCH_FLAG  += --timestamp 1691052364
